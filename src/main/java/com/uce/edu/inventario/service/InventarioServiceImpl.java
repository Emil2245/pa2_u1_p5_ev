...
public class InventarioServiceImpl implements IInventarioService {
    ...
    @Override
    public void guardar(Inventario cuentaBancaria) {
        this.iInventarioRepository.insertar(cuentaBancaria);

    }

    @Override
    public void actualizar(Inventario cuentaBancaria) {
        this.iInventarioRepository.actualizar(cuentaBancaria);
